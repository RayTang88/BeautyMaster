...
# def reset_local_func(instruction_txtbox: gr.Textbox,
...
if __name__ == '__main__':
    ...
    with image_blocks as Match:
        ...
        gr.Markdown("使用方法：1.在美妆搭配页面按示例上传一张全身照，点击Match按钮，大模型会给出穿搭建议；2.点击Try On，将推荐的穿搭建议给您试穿展示。目前我们内置了一个精简的服饰数据库供基础效果展示。 如果使用过程中出现错误提示，请重复前面的步骤即可，感谢您的使用！")
