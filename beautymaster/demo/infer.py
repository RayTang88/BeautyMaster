...
def run(weights_path="",  # model.pt path(s)
    ...
    response_string = infer_vlm_4o_like_func(weights_path, weight_name, model_candidate_clothes_list, season, weather, determine)
...
def parse_opt():
	...
	parser.add_argument('--weather', type=str, default='0~5摄氏度', help='weather')
	parser.add_argument('--season', type=str, default='冬季', help='season')
