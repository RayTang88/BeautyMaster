...
def parse_opt():
	...
	parser.add_argument('--vlm-weight-name', nargs='+', type=str, default='/InternVL-Chat-V1-5-AWQ/', help='MiniCPM-Llama3-V-2_5/InternVL-Chat-V1-5-AWQ')
	parser.add_argument('--llm-weight-name', nargs='+', type=str, default='/internlm2-chat-20b-4bits/', help='internlm2-chat-7b/internlm2-chat-20b-4bits')
