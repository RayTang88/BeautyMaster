...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False, labels=(), max_det=300):
	...
	return output
# origin letterbox will change the output shape, we commit many code for keep new shape we wanted.
def letterbox_keep_new_shape(im, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, stride=32):
